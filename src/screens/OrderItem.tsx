...
import { addProductToOrder, getByOrderId } from "../services/OrderItems";
...
const OrderItem = ({user, products}: Props) => {
    ...
    const confirmProduct = async (id: number)=>{
        ...
        const productAdded = await addProductToOrder(orderData.orderId, newOrderItem);

        const orderItem = {
            quantity: newOrderItem.quantity,
            productId: id,
            productName: createdProduct.name,
            orderItemId: productAdded.id,
